-- Add truck columns to order_sms_webhooks table
ALTER TABLE public.order_sms_webhooks 
ADD COLUMN truck_registration text,
ADD COLUMN truck_type text;

-- Update the populate_order_sms_webhook function to include truck information
...
-- Backfill existing records with truck information
UPDATE public.order_sms_webhooks osw
SET 
  truck_registration = o.truck_registration,
  truck_type = o.truck_type_display
FROM orders o
