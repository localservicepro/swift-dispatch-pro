...
import { CompactStatusIndicators } from "./CompactStatusIndicators";
...
export function OpportunityCardHeader({ 
  ...
  return (
    <div className="mb-3">
      {/* Top row: Order number and action buttons */}
      ...
      {/* Second row: PO and Status Icons */}
      <div className="flex items-center justify-between">
        ...
        <CompactStatusIndicators order={order} />
      </div>
    </div>
  );
}
